...
3. **Ebook** → KDP → D2D.
4. **Print** → Notion Press (India). KDP Print for the rest of the world comes later.
...
## Print interior (Notion Press, 5.5 × 8.5)
...
- Everything before the first chapter heading is replaced by print front matter (half-title, title, copyright). ISBN line is omitted until known; Notion Press assigns it.
